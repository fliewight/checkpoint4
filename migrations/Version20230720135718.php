 ...
 */
final class Version20230720135718 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE joke (id INT AUTO_INCREMENT NOT NULL, category_id INT DEFAULT NULL, content LONGTEXT NOT NULL, INDEX IDX_8D8563DD12469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
